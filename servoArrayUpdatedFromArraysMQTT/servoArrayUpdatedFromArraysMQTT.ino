...
void messageReceived(String &topic, String &payload) {
  ...
  servos[servoId].setArrays(servoPositions, servoIntervals, 5);
}
void setup() {
  Serial.begin(115200);
  ...
  for (int i = 0; i < NUM_SERVOS; i++) {
    //    servos[i] = new Servo(1, 0, SERVOMIN, SERVOMAX, 1000);
    servos[i].setArrays(servoPositionsA, servoIntervalsA, 7);
  }
}
